                ...
                <section className="hero is-primary is-large p-6" >
                        <div className="hero-footer has-text-centered">
                              ...
                              <div className="is-flex is-justify-content-space-around mt-6">
                                  ...
                                  <a href="https://www.linkedin.com/in/pegwende-p-zabsore/" target="_blank">
                                      <i class="icon fab fa-linkedin is-large"></i>
                                  </a>
                                  <a href="https://www.facebook.com/aristide.zabsore" target="_blank">
                                      <i class="icon fab fa-facebook is-large"></i>
                                  </a>
                                  <a href="https://web.whatsapp.com/" target="_blank">
                                      <i class="icon fab fa-whatsapp-square is-large"></i>
                                  </a>
                              </div>
                          </div>
                </section>
